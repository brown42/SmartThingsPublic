 ...
 */
metadata {
	definition (name: "Ecobee Thermostat", namespace: "brown42", author: "SmartThings") {
		capability "Actuator"
        ...
        attribute "currentClimateRef", "string"
	}
	...
	tiles {
        ...
        valueTile("currentClimateRef", "device.currentClimateRef", decoration: "flat") {
        	state "default", label: '${currentValue}'
        	state "currentClimateRef", label: '${currentValue}'
        }
		...
		main "temperature"
		details(["temperature", "upButtonControl", "thermostatSetpoint", "currentStatus", "downButtonControl", "mode", "currentClimateRef", "fanMode","humidity", "resumeProgram", "refresh"])
	}
